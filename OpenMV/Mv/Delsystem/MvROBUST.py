# This code is less prome to erros but has lower fps
...
while True:
    ...
    while True:
        ...
        if middleCrossing or leftCrossing and rightCrossing:
            leftLaneLine = getLaneLine(laneAppropiateSide, [(255, 255)], 20, False, 4, 4, LEFT_LANE_ROI_WALK)
            ...
            middleLaneLine = getLaneLine(laneAppropiateMiddle, [(255, 255)], 20, False, 4, 4, MIDDLE_LANE_ROI)
