...
// cars.forEach(car => {
//     if (car.carCoord[0] === coord[0] && car.carCoord[1] === coord[1]) {
//         console.log('acording to all know laws of elevitaitions')
//         return false
//     }
// });
